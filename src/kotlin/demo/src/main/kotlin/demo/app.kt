...
fun testDataClass() {
    val bob = DataClient("Bob", 123456)
    println(bob.copy(postalCode = 654321))
}
...
fun testObjectClass() {
    Payroll.allEmpolyees.add(Person("Mary"))
    Payroll.calculateSalary()
}

data class File(private val path: String) {
    fun getPath() = path
}
...
fun testObjectInheritClass() {
    println(CaseInsensitiveFileComparator.compare(File("/User"), File("/user")))
}

data class InnerPerson(val name: String) {
    object NameComparator: Comparator<InnerPerson> {
        override fun compare(p1: InnerPerson, p2: InnerPerson): Int = 
            p1.name.compareTo(p2.name)
    }
}

fun testInnerObjectClass() {
    val persons = listOf(InnerPerson("Bob"), InnerPerson("Alice"))
...
fun main(args: Array<String>) {
    ...
    testClassDelegation()
    testObjectClass()
    testObjectInheritClass()
    testInnerObjectClass()
}