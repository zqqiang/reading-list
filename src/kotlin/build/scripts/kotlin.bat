...
set CLASSPATH=%APP_HOME%\lib\kotlin.jar;%APP_HOME%\lib\kotlin-stdlib-1.0.0.jar;%APP_HOME%\lib\kotlin-runtime-1.0.0.jar

@rem Execute kotlin
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KOTLIN_OPTS%  -classpath "%CLASSPATH%" app %CMD_LINE_ARGS%
